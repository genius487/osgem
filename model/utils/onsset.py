...
class SettlementProcessor:
    ...
    def calibrate_current_pop_and_urban(self, pop_actual, urban_current, scen):
        """
    ...
    def calibrate_elec_current(self, elec_actual, elec_actual_urban, elec_actual_rural, start_year, scen, min_night_lights=0,
        ...
        if scen == 0:
            ...
            logging.info('Copying and Creating columns for scenario analysis')
            ...
            #logging.info('Calibrate current electrification')
            #self.df[SET_ELEC_CURRENT] = self.df[SET_ELEC_CURRENT]
